...
for esta in list(red.codcorto):
    try:
        df = fut.get_fastRSAM2(fechai,fechaf,esta,rangef[0],rangef[1],5,True,'15T')
    ...
    try:
        for comp in ['N','E']:
            df2 = fut.get_fastRSAM2(fechai,fechaf,esta+comp,rangef[0],rangef[1],5,True,'15T')
...
fig = crear_fastRSAM(RSAM,voldata,fechai,fechaf,rangef,sampling)
